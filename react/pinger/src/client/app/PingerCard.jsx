...
class PingerCard extends React.Component {
  ...
  constructor(props) {
    ...
    this.color = ['grey', 'green', 'red', 'yellow'];
    this.altText = ['Pending or unknown failure', 'Server is up', 'Server is unreachable', 'Server is up but there was a problem reaching this page'];
